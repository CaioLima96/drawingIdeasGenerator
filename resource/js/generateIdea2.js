        ...
        document.getElementById('ideasList').innerHTML += `
                ...
                <li class='generatedIdea' dataSubTheme='${item.dataSubTheme}'>
                    <p style='margin-bottom: 16px'>
                        ...
                        ${item.dataSubTheme == 'hungryDragons' || item.dataSubTheme == 'hungrySharkWorld' || item.dataSubTheme == 'minecraft' || item.dataSubTheme == 'fortnite' || item.dataSubTheme == 'angryBirds'  || item.dataTheme == 'animes' || item.dataTheme == "ben10" ? `(${item.dataSubTheme})` : ''}
                    </p>
